  ...
  return (
    <div className="card mt-20 flex flex-col border px-2">
      <div data-aos="zoom-in">
        <h1 className="judul text-center font-bold sm:text-4xl text-2xl pb-10">
          Special Thanks
        </h1>
      ...
      <div data-aos="zoom-in" className="grid grid-cols-2">
        ...
        <div
          data-aos="fade-right"
          className="pt-5 m-3 flex flex-col lg:justify-center lg:items-center sm:flex-row gap-2"
        >
          <div>
            <img
              className="bg-white rounded-full border w-[200px]"
              src="../Png/nextjs.png"
              alt=""
            />
          </div>
          <div className="text-justify">
            ...
            Website,like frontend and backend
          </div>
          <div className="mockup-code">
            <pre data-prefix="1">
              <code>npx create-next-app@latest</code>
            </pre>
            <pre data-prefix="2" className="text-yellow-400">
              <code>installing...</code>
            </pre>
            <pre data-prefix="3" className="text-yellow-400">
              done
            </pre>
          </div>
        </div>
